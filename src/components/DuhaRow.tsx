  ...
  return (
    <div class="w-full text-black bg-white px-7 pb-5 flex flex-row items-center justify-between">
      ...
      <div class="flex flex-col items-center justify-start">
        <div class="text-7xl text-green-800 text-left" dir="rtl">
          يبدأ الضحى الساعة
        </div>

        <div class="text-7xl text-green-800">DUHA BERMULA</div>
      ...
      <div class="flex flex-col items-center justify-end">
        ...
        <div class="text-7xl text-green-800 text-right">MATAHARI TERBIT</div>
